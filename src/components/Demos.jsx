...
const VideoPreview = ({ src, onClick, portrait = false }) => (
  <div
    className={`relative rounded-xl mb-6 overflow-hidden border border-white/[0.08] cursor-pointer group ${portrait ? 'aspect-[9/16] w-full' : 'w-full aspect-video'}`}
    onClick={onClick}
  >
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-6 h-full">
            ...
            <div className="flex flex-col justify-center">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-2.5 py-1 rounded-full bg-[#2997ff]/20 text-[#2997ff] text-xs font-medium border border-[#2997ff]/20">Projet entrepreneurial</span>
              </div>
